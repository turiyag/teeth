...
function loadBubbles(bubbles) {
	if(!(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent))) {
		...
		$("#bubblebox").bubble({x:980,y:250,radius:100,text:bubbles[2].text,link:bubbles[2].link,pic:bubbles[2].pic});
		$("#bubblebox").bubble({x:980,y:450,radius:100,text:bubbles[3].text,link:bubbles[3].link,pic:bubbles[3].pic});
		//$("#bubblebox").bubble({x:700,y:600,radius:100,text:bubbles[4].text,link:bubbles[4].link,pic:bubbles[4].pic});
	} else {
